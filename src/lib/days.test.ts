...
const exs = new Map<number, Exercise>([
  [10, { id: 10, name: 'Supino', kind: 'strength', categoryIds: [1], alternativeIds: [] }],
  [11, { id: 11, name: 'Crucifixo', kind: 'strength', categoryIds: [1], alternativeIds: [] }],
  [12, { id: 12, name: 'Tríceps Corda', kind: 'strength', categoryIds: [2], alternativeIds: [] }],
  [13, { id: 13, name: 'Puxada', kind: 'strength', categoryIds: [3], alternativeIds: [] }],
  [14, { id: 14, name: 'Sem categoria', kind: 'strength', categoryIds: [], alternativeIds: [] }], // no category
  [15, { id: 15, name: 'Supino Inclinado', kind: 'strength', categoryIds: [1, 2], alternativeIds: [] }], // compound: Peito + Tríceps
])
