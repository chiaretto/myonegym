# exercise-videos Specification

## Purpose
Os **vídeos de execução** de um exercício: como o movimento se faz. A mídia do
exercício é uma imagem, e uma imagem não mostra cadência, ângulo de banco nem
