# warmups Specification

## Purpose
O **Aquecimento**: como preparar o movimento. O app já sabia **o que** treinar
(exercício, peso, dia) e **onde** (academia), mas o preparo vivia fora dele — em
prints no rolo da câmera ou num vídeo salvo. É conteúdo **compartilhado** (o
mesmo aquecimento de manguito serve supino, desenvolvimento e crucifixo), então
é um registro próprio ligado a muitos exercícios, e não uma cópia por exercício —
o mesmo erro que "copiar pesos" era antes de o peso virar global.
