...
and with future sessions of the same exercise in the same gym. Enquanto uma **alternativa** está sendo vista, as três abas MUST refletir o
exercício **exibido**, não o da entrada — é a nota e a foto daquele aparelho que
ajudam a decidir. When the entry has
