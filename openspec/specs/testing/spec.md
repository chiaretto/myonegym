...
## Purpose
A **suíte automatizada** como instrumento: o que ela promete, e o que faz essa
promessa valer.

Um app offline-first sem backend não tem staging nem telemetria — o que se sabe
sobre uma regressão é o que a suíte disser. Por isso o valor dela não está em
existir, e sim em ser **crível**: um vermelho que aparece e some ensina a rodar
de novo em vez de investigar, e a partir daí a suíte deixa de valer como sinal
enquanto continua custando o tempo de espera.

Esta capability guarda as regras que mantêm o vermelho significando alguma coisa
— determinismo, prazos escolhidos em vez de herdados, e lentidão que continua
visível mesmo depois de tolerada.
